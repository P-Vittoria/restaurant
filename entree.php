...
<div class="main-container">
  <div class="Category listing">
    <h1><center>Entrees</h1></center>
    <h3><a href="menu.html">&larr; &#32;Back to Categories</a></h3>
    <br/ ><center>
    <img src="images/entree.jpg" width="100%" height="600" alt="entree" /></center>
<br>
...
$sql = "SELECT i.cid, i.iid, i.item_name, i.disc, i.price, i.display FROM item as i WHERE i.cid= '5' and i.display= '1'";

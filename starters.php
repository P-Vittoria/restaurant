...
<div class="main-container">
  <div id="content">
      <div class="Category listing">
        ...
        <br/ ><center>
        <img src="images/starters.jpg" width="100%" height="600" alt="starters" /></center>
      </div>
  </div>
<br>
...
$sql = "SELECT i.cid, i.iid, i.item_name, i.disc, i.price, i.display FROM item as i WHERE i.cid= '1' and i.display= '1'";
